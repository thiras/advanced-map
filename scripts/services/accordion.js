app.service("$accordion", function ($rootScope) {
    ...
    this.refreshAccordion=function (lang) {
        return {
            menu1: {
            ...
            menu5: {
                ...
                submenu: {
                    ...
                    menu3e1: {
                        label: lang.menu.menu9.menu1e5,
                        fonk: "findGooglePOI"
                    },
                    menu3e4: {
                        label: lang.menu.menu9.menu1e6,
                        fonk: "findFoursquarePOI"
                    }
                }
            },
            menu9: {
    ...
    this.json = this.refreshAccordion(lang);
    return this;
});